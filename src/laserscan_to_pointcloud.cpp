...
ScanToPointCloud::ScanToPointCloud(){
        _sub = _node.subscribe<sensor_msgs::LaserScan> ("simulator/scan", 100, &ScanToPointCloud::scanCb, this);
        _pub = _node.advertise<sensor_msgs::PointCloud2> ("simulator/cloud", 100, false);
